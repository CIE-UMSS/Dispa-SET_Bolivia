...
config = ds.load_config('../ConfigFiles/Config_BOLIVIA_2050_EPI_SI_FFR.xlsx')
...
inputs,results = ds.get_sim_results(path='../Simulations/BOLIVIA_2050_EPI_SI_FFR',cache=False)
...
inputs_MTS, results_MTS = ds.get_sim_results(path='../Simulations/BOLIVIA_2050_EPI_SI_FFR', cache=False, inputs_file='Inputs_MTS.p',results_file='Results_MTS.gdx')
