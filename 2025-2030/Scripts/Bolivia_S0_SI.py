...
config = ds.load_config('../ConfigFiles/Config_BOLIVIA_S0_SC.xlsx')
...
inputs,results = ds.get_sim_results(path='../Simulations/BOLIVIA_S0_SC',cache=False)

# Load the simulation results MTS:
inputs_MTS, results_MTS = ds.get_sim_results(path='../Simulations/BOLIVIA_S0_SC', cache=False, inputs_file='Inputs_MTS.p',results_file='Results_MTS.gdx')
