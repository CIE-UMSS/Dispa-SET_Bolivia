...
config = ds.load_config('../ConfigFiles/Config_BOLIVIA_S0_NC.xlsx')
...
inputs,results = ds.get_sim_results(path='../Simulations/BOLIVIA_S0_NC',cache=False)

# Load the simulation results MTS:
inputs_MTS, results_MTS = ds.get_sim_results(path='../Simulations/BOLIVIA_S0_NC', cache=False, inputs_file='Inputs_MTS.p',results_file='Results_MTS.gdx')

# # import pandas as pd
import pandas as pd

# Generate country-specific plots   
rng = pd.date_range('2030-01-01', '2030-01-03', freq='H')
for i in config['zones']:
    ds.plot_zone(inputs, results, z=i, rng=rng)

# Generate country-specific plots MTS    
rng1 = pd.date_range('2030-01-01', '2030-01-03', freq='D')
